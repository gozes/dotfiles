      ...
      highlight_overrides = {
        all = function(colors)
          return {
            ...
            MiniStatuslineModeCommand = { bg = jbsatuslinebackground, fg = blackbackground },
            MiniStatuslineModeNormal = { bg = jbsatuslinebackground, fg = blackbackground },
            MiniStatuslineModeOther = { bg = jbsatuslinebackground, fg = blackbackground },
            MiniStatuslineModeReplace = { bg = jbsatuslinebackground, fg = blackbackground },
            MiniStatuslineModeVisual = { bg = jbsatuslinebackground, fg = blackbackground },
            MiniStatuslineModeInsert = { bg = jbsatuslinebackground, fg = blackbackground },
            MiniStatuslineInactive = { bg = jbsatuslinebackground, fg = blackbackground },
            MiniStatuslineFilename = { bg = jbsatuslinebackground, fg = blackbackground },
            MiniStatuslineFileinfo = { bg = jbsatuslinebackground, fg = blackbackground },
            MiniStatuslineDevinfo = { bg = jbsatuslinebackground, fg = blackbackground },
